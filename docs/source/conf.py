...
html_title = 'Documentation for ant, version {0}'.format(ant.__version__)
...
# [howto/manual]).
latex_documents = [
    ('index', 'ant.tex', 'Documentation for ant', 'Martín Raúl Villalba', 'manual')
]
...
man_pages = [('index', 'ant', 'Documentation for ant', ['Martín Raúl Villalba'], 1)]
